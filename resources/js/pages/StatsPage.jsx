...
import ScrollArea from "../components/ui/ScrollArea"; // 👈 nuevo
...
export default function StatsPage() {
  ...
  return (
    <AppLayout header={header}>
      {/* Wrapper: permite que ScrollArea tome el alto restante en XL */}
      <div className="flex flex-col min-h-0 xl:h-full gap-4">
        ...
        {/* Contenido scrolleable en desktop/XL; flujo natural en móvil */}
        <ScrollArea /* showOnHover opcional: showOnHover */
          className=""
        >
