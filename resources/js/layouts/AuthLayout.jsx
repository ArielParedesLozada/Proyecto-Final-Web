export default function AuthLayout({ title = "FinSave", subtitle, step, email, children }) {
  return (
    <div className="h-svh overscroll-contain flex flex-col overflow-y-auto scroll-invisible">
      {/* Header compacto */}
